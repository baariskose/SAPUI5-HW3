		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee List",
									"targetURL": "#comsmodemployeelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodemployeelist-display": {
								"semanticObject": "comsmodemployeelist",
								"action": "display",
								"description": "Employee card applikation ",
								"title": "Employee List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.employeelist",
									"url": sap.ui.require.toUrl("com/smod/employeelist")
								}
							}
						}
					}
